...
const ErrorPage = () => {
    return (
        <section className="flex items-center h-full p-16 text-slate-800">
            <div className="container flex flex-col items-center justify-center px-5 mx-auto my-8">
                <div className="max-w-md text-center">
                    ...
                    <Link rel="noopener noreferrer" to="/" className="px-8 py-3 font-semibold rounded bg-[#23BE0A] text-white">Back to homepage</Link>
                </div>
            </div>
        </section>
    );
